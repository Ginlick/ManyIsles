        ...
        <div class="Box default">
          <form>
            <div class="inBoxForm">
              ...
              <input type="date" name="date-happens" id ="date-happens" value="" min="" max="" onload="fixDate(this, min)">
              ...
              <input type="date" name="date-opens" id="date-opens" value="" min="" max="" onload="fixDate(this, min)">
              <h3>Settings</h3>
            </div>
          </form>
        </div>
