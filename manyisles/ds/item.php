...
?>
                    ...
                    <a href="https://www.facebook.com/sharer/sharer.php?u=https://kartecaedras.ch/ds/<?php echo $artLink; ?>" target="_blank" class="fa-brands fa-facebook"></a>
                    <a href="http://www.reddit.com/submit?title=Check out <?php echo $artName; ?> on the Many Isles!&url=https://kartecaedras.ch/ds/<?php echo $artLink; ?>" target="_blank" class="fa-brands fa-reddit"></a>
                    <a href="https://twitter.com/intent/tweet?text=Check out the awesome <?php echo $artName; ?> on the Many Isles!%0A&url=https://kartecaedras.ch/ds/<?php echo $artLink; ?>&hashtags=manyisles,dnd" target="_blank" class="fa-brands fa-twitter"></a>
                    <a href="http://pinterest.com/pin/create/button/?url=https://kartecaedras.ch/ds/<?php echo $artLink; ?>&media=<?php echo $ds->clearImgUrl($artImage); ?>&description=Check out the awesome <?php echo $artName; ?> on the Many Isles!" target="_blank" class="fa-brands fa-pinterest"></a>
