...
//doing 
$query = "UPDATE dsprods SET status = 'active' WHERE id = $artId";
if ($result = $conn->query($query)){
    header("Location:item.php?why=restItem&id=$artId");exit();
}
else {
    $error = $conn->error;
}
...
<body>
    ...
    <div class="flex-container">
        ...
        <div id='content' class='column'>
            <h1>Error Restoring Item </h1>
            <div class='dsBanner'><img src='/Imgs/Oops.png' alt:'Oopsie!'></div>
            <p>Your item could not be restored.
