...
$gen = new gen("view", 0, $wiki, true, "mystral");
...
<head>
    ...
    <title>Search <?php echo $gen->wikiName." ".$gen->groupName." | ".$gen->domainName; ?></title>
...
<body  style="<?php echo $gen->giveWikStyle(); ?>">
    ...
    <div class="content">
        ...
        <div class="fandomrcoll">
            <div class="col-r">
                ...
                <div class="topinfo"><a href="/mystral/hub">Mystral</a> - <a href="/mystral/<?php echo $gen->parentWiki; ?>/home"><?php echo $gen->wikiName; ?></a> - <a href="#">Search</a></div>
                <h1>Search Results<a href="/mystral/<?php echo $wiki; ?>/home"><span class='roundInfo title'><?php echo $gen->wikiName." ".$gen->groupName; ?> </span></a></h1>
                <div style="width:100%;">
    ...
    <?php
    $query = "SELECT * FROM wikicategories WHERE wiki = ".$wiki." AND user = $gen->user";
