...
$query = "SELECT * FROM accountsTable WHERE id = ".$id;
 ...
 $cpsw = openssl_decrypt ( $psw, "aes-256-ctr", "Ga22Y/", 16);
...
?>
    ...
    <div class="contentBlock">
    <h1>Your <?php if ($ptype=="prem"){echo "Partnership";} else {echo "Companionship";} ?></h1>
...
<input id="rjInput" type ="text" name="njacob" pattern="[A-Za-z0-9\'\-\:\;\(\)\.\,\!\? ]{2,}" placeholder="<?php echo $pjacob; ?>"  style="width:60%"/>
