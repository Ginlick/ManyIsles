...
<body>
    ...
    <div class="content">
        ...
        <div class="col-r" style="margin-bottom:50px;">
            ...
            <h1>Fandom</h1>
            <p>
                The Many Isles Fandom Wiki is an awesome platform where you can create extensive wikis about your setting, for free.  <?php if (!isset($_COOKIE["loggedIn"])) {echo ' <a href="/account/Account.html">Create an account</a> to get started! '; } ?><br />
