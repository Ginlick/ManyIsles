...
function equipDom($gen, $domain = "fandom"){
    ...
    $gen->conn = giveConn();
    if (isset($_COOKIE["loggedIn"])){ $gen->user = $_COOKIE["loggedIn"];}
    else {$gen->user = 0;}
